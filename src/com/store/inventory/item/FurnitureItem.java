...
public class FurnitureItem extends InventoryItem implements Breakable {
    FurnitureItem(String title, String description, BigDecimal price, Category... categories) {
